...
To connect your bank account for online payments, go to the [Billing](https://platform.tutoros.app/billing) section in the app and click the `Connect Bank Account` button:
