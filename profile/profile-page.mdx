...
![Profile Page 2](/images/profile-page-4.png)
...
Below are instructions on how to embed your code in some of the most common website platforms. Each platform has its own interface and terminology, but the general idea is: add a custom HTML element (or code block) and paste in the iframe snippet.
