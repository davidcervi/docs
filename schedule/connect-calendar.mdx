...
In TutorOS, you can connect an external calendar (such as your Google/Gmail or Outlook calendar) so that events from this calendar are automatically displayed in your TutorOS schedule.
...
If you select Google, you will be prompted to select the email address associated with the calendar you wish to connect:
...
will automatically be added to your Google calendar.

![Connect Google Calendar 3](/images/connect-google-calendar-3.png)

### Outlook

If you select Outlook, you will be asked to grant TutorOS permission to read/write events from the calendar of the Outlook email address that you are currently signed in with:

![Connect Outlook Calendar 1](/images/connect-outlook-calendar-1.png)

Click the `Accept` button to complete the process. Your Outlook calendar events will now be displayed inside your schedule in TutorOS, and future TutorOS lessons
will automatically be added to your Outlook calendar.

![Connect Outlook Calendar 2](/images/connect-outlook-calendar-2.png)
