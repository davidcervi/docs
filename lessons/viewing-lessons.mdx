...
A Lesson Resource is an optional document that you can add it an upcoming lesson. It will then be displayed in the [classroom](/lessons/classroom) so you can easily read through it with the student during the lesson.
...
![Viewing Lessons 3](/images/viewing-lessons-1.png)
