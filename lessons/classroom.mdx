...
Each lesson on TutorOS takes place in our virtual classoom. Once you enter the classroom, the Zoom call for the lesson will automatically open.

The classroom consists of the following sections:

## Sections

### Class Notes

This is the editor where you can take notes throughout the lesson. The student also has access to the classroom, allowing them to see the notes you add in real time and contribute their own notes as well.
...
This section provides basic information about the lesson, including the student’s name and the lesson time.

### Resource

The resource uploaded for this lesson. This can be any PDF, doc file (or Google Drive link). For example, it could be an article, a sample Math paper, etc.
