...
The resource uploaded for this lesson. This can be a PDF file, a .docx file, or a Google Drive link. For example, it could be an article, a sample math paper, etc.
