...
The Feedback screen contains the feeback form, consisting of two questions. The lesson class notes, summary, transcript and recording (see [here](lessons/post-lesson-classroom) for more details) are also provided, which you can use as an aid when filling out your feedback and to review your lesson. 
