...
If the student cancels a lesson, the outcome will depend on the lesson [payment & cancellation policy](/templates/create-new-template#3-define-policies), the timing of the cancellation, and whether the lesson was booked as part of a lesson package. Based on these factors, one of the following will apply:
