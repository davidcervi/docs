...
If the student cancels a lesson, then depending on the lesson [cancellation policy](/templates/create-new-template#cancellation-policy) and when they cancel, one of the following will happen:

- Issued a full refund.
- Issued a partial refund.
- Issued no refund.
- Sent an email stating that the full lesson payment is now due.
- Sent an email stating that a partial lesson payment is now due.
- Sent an email stating that no payment is due.
